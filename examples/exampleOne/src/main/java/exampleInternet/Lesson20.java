...
//You must extend the JFrame class to make a frame (window)

public class Lesson20 extends JFrame {

	public Lesson20() {

		// Define the size of the frame (window)
		...
		/////////// this.setResizable(false); //false/true
		...
		// Change the size of the text field (width)
		...
		// Gets the number of newlines in the text (count new line "\n") 
		int numOfLines = textArea1.getLineCount();

		// Appends text after the current text
		textArea1.append(" number of lines: " + numOfLines);

		textArea1.append("One more line");
		numOfLines = textArea1.getLineCount();
		...
		// jpanel - scroll
		JScrollPane sp = new JScrollPane(thePanel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
